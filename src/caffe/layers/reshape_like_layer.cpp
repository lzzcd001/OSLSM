...
#include "caffe/layers/reshape_like_layer.hpp"

namespace caffe {

template <typename Dtype>
void ReshapeLikeLayer<Dtype>::LayerSetUp(const vector<Blob<Dtype>*>& bottom,
...
INSTANTIATE_CLASS(ReshapeLikeLayer);
REGISTER_LAYER_CLASS(ReshapeLike);
